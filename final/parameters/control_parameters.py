...
wn_roll = 10 # error in roll when aileron saturates
...
#----------yaw damper-------------
yaw_damper_p_wo = 0.45 # washout filter cutoff frequency
yaw_damper_kr = 0.2 # gain for yaw damper

#----------pitch loop-------------
wn_pitch = 15.0 # nat freq for pitch
...
wn_airspeed_throttle = 1.5 # nat freq airspeed hold loop
